...
<body>
    ...
    <table class="blog_form">
		<tr>
			<th><input type="text" placeholder="name" name="var_name" class="conf_input"></th>
			<th><input type="text" placeholder="title" name="var_value" class="conf_input"></th>
			<th><input type="text" placeholder="description" name="var_description" class="conf_input"></th>
			<th><input type="text" placeholder="text" name="var_text" class="conf_input"></th>
